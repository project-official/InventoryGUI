                ...
                val anim = this.player.animatedGui(text("Hi", NamedTextColor.GREEN)) {
                    ...
                    for (i in 0 until 50) {
                        frame(i * (if (i <= 20) 2 else if (i <= 10) 4 else if (i <= 10) 8 else 16)) {
                            ...
                            slot(
                                12,
                                ItemStack(if (rand == 0) Material.GOLDEN_APPLE else if (rand == 1) Material.IRON_INGOT else Material.DIRT)
                            )
                            slot(
                                13,
                                ItemStack(if (rand2 == 0) Material.GOLDEN_APPLE else if (rand2 == 1) Material.IRON_INGOT else Material.DIRT)
                            )
                            slot(
                                14,
                                ItemStack(if (rand3 == 0) Material.GOLDEN_APPLE else if (rand3 == 1) Material.IRON_INGOT else Material.DIRT)
                            )
                        }
                    }
                }
